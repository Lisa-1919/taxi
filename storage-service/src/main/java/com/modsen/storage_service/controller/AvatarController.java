...
public class AvatarController {
    ...
    @PostMapping
    public ResponseEntity<?> uploadAvatar(@Valid @RequestBody UploadAvatarDto uploadAvatarDto){
    ...
    @PutMapping("/{userId}")
    public ResponseEntity<String> editAvatar(@PathVariable UUID userId, @RequestBody UploadAvatarDto uploadAvatarDto) {
